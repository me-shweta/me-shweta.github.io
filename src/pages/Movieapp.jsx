        ...
        <div className="space-y-32 text-lg leading-relaxed text-slate-900/90">
          ...
          <section className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-6 pt-10 items-center justify-center">
              <img src="/public/movie/homescreen.png" alt="Homescreen with personalized banners" className="w-full md:w-1/2 max-w-sm rounded-2xl border border-slate-100 shadow-xl" />
              <img src="/public/movie/language.png" alt="Language selection with country flags" className="w-full md:w-1/2 max-w-sm rounded-2xl border border-slate-100 shadow-xl" />
            </div>
